...
//{
//    "id": "09d4a079-7f6c-4d4d-b03f-8f3fe72de1f9",
//    "name": "mattermost-dev",
//    "type": "smartmachine",
//    "brand": "lx",
//    "state": "running",
//    "memory": 1024,
//    "disk": 25600,
//    "ips": ["192.168.128.75", "165.225.168.210"],
//    "metadata": {},
//    "tags": {
//        "sdc_docker": true
//    },
//    "created": "2015-12-09T23:34:48.257Z",
//    "updated": "2016-05-30T16:07:51.000Z",
//    "docker": true,
//    "package": "t4-standard-1G"
//    "image": "d43f8876-ff19-b7a7-4c18-70fb61aa8e5e",
//    "primaryIp": "165.225.168.210",
//    "networks": ["2f8a6f02-c694-4cd4-8397-426c82723b66", "feb7b2c5-0063-42f0-a4e6-b812917397f7"],
//    "firewall_enabled": true,
//    "compute_node": "44454c4c-4400-1043-8053-b5c04f383432",
//}
...
type Machine struct {
	...
	Tags            map[string]interface{} // Map of the machine tags, values may be strings, numbers or bools
	Created         string            // When the machine was created
	Updated         string            // When the machine was updated
	Docker			bool			  // Whether this machine is a Docker container, if present
	...
	ComputeNode     string            `json:"compute_node"` // UUID of the server on which the machine is located
}

// Equals compares two machines. Ignores state and timestamps.
func (m Machine) Equals(other Machine) bool {
	if m.Id == other.Id && m.Name == other.Name && m.Type == other.Type && m.Brand == other.Brand &&
